...
VALUES
('Advanced Algorithms and Data Structures', 'Exploring complex algorithms and advanced data structures used in optimizing computational processes and problem-solving.', NULL),
('Machine Learning and Artificial Intelligence', 'Investigating the principles and applications of machine learning and AI techniques in developing intelligent systems and algorithms.', NULL),
('Network Security and Cryptography', 'Understanding cryptographic principles and network security protocols to protect information and ensure secure communication over networks.', NULL),
('Wireless and Mobile Networking', 'Studying wireless communication technologies and protocols alongside mobile networking architectures and their applications in modern communication systems.', NULL),
('Ethical Hacking and Penetration Testing', 'Exploring the methods and tools used by ethical hackers to identify vulnerabilities and conduct penetration tests to secure networks and systems.', NULL),
...
(7, 'Digital Marketing Strategies and Analytics'),
(8, 'Vulnerability Assessment and Risk Management');
